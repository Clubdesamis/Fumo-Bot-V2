...
__attribute__((unused)) static uint32_t emote_adjustServos[] =
{
		HEADER(4),
		START(ARM_RIGHT),			START(ARM_LEFT),			START(BOUNCE_RIGHT),			START(BOUNCE_LEFT),
		SET_ANGLE_D1(ARM_RIGHT, 70, 80),	SET_ANGLE_D1(ARM_LEFT, 70, 80),	SET_ANGLE_D1(BOUNCE_RIGHT, 110, 80),	SET_ANGLE_D1(BOUNCE_LEFT, 110, 80),
		FINISH(ARM_RIGHT),			FINISH(ARM_LEFT),			FINISH(BOUNCE_RIGHT),			FINISH(BOUNCE_LEFT)
};



__attribute__((unused)) static uint32_t emote_testServos[] =
{
		HEADER(4),
		START(ARM_RIGHT),			START(ARM_LEFT),			START(BOUNCE_RIGHT),			START(BOUNCE_LEFT),

		SET_ANGLE_D1(ARM_RIGHT, 0, 100),
		DELAY(ARM_RIGHT, 600),
		SET_ANGLE_D1(ARM_RIGHT, 180, 100),
		DELAY(ARM_RIGHT, 600),
		SET_ANGLE_D1(ARM_RIGHT, 90, 100),

		BARRIER(ARM_RIGHT, 0),		BARRIER(ARM_LEFT, 0),		BARRIER(BOUNCE_RIGHT, 0),			BARRIER(BOUNCE_LEFT, 0),

									SET_ANGLE_D1(ARM_LEFT, 0, 100),
									DELAY(ARM_LEFT, 600),
									SET_ANGLE_D1(ARM_LEFT, 180, 100),
									DELAY(ARM_LEFT, 600),
									SET_ANGLE_D1(ARM_LEFT, 90, 100),
									DELAY(ARM_LEFT, 600),

		BARRIER(ARM_RIGHT, 1),		BARRIER(ARM_LEFT, 1),		BARRIER(BOUNCE_RIGHT, 1),			BARRIER(BOUNCE_LEFT, 1),
																SET_ANGLE_D1(BOUNCE_RIGHT, 0, 100),
																DELAY(BOUNCE_RIGHT, 600),
																SET_ANGLE_D1(BOUNCE_RIGHT, 180, 100),
																DELAY(BOUNCE_RIGHT, 600),
																SET_ANGLE_D1(BOUNCE_RIGHT, 90, 100),
																DELAY(BOUNCE_RIGHT, 600),
		BARRIER(ARM_RIGHT, 2),		BARRIER(ARM_LEFT, 2),		BARRIER(BOUNCE_RIGHT, 2),			BARRIER(BOUNCE_LEFT, 2),
																									SET_ANGLE_D1(BOUNCE_LEFT, 0, 100),
																									DELAY(BOUNCE_LEFT, 600),
																									SET_ANGLE_D1(BOUNCE_LEFT, 180, 100),
																									DELAY(BOUNCE_LEFT, 600),
																									SET_ANGLE_D1(BOUNCE_LEFT, 90, 100),
																									DELAY(BOUNCE_LEFT, 600),
		BARRIER(ARM_RIGHT, 3),		BARRIER(ARM_LEFT, 3),		BARRIER(BOUNCE_RIGHT, 3),			BARRIER(BOUNCE_LEFT, 3),

		FINISH(ARM_RIGHT),			FINISH(ARM_LEFT),			FINISH(BOUNCE_RIGHT),			FINISH(BOUNCE_LEFT)
};

__attribute__((unused)) static uint32_t emote_wave[] =
{
		HEADER(4),
		START(ARM_RIGHT),			START(ARM_LEFT),			START(BOUNCE_RIGHT),			START(BOUNCE_LEFT),
																SET_ANGLE_D1(BOUNCE_LEFT, 50, 250),
									SET_ANGLE_D0(ARM_LEFT, 140),
									DELAY(ARM_LEFT, 150),
		BARRIER(ARM_RIGHT, 0),		BARRIER(ARM_LEFT, 0),		BARRIER(BOUNCE_RIGHT, 0),			BARRIER(BOUNCE_LEFT, 0),
									SET_ANGLE_D0(ARM_LEFT, 80),
									DELAY(ARM_LEFT, 150),
									SET_ANGLE_D0(ARM_LEFT, 140),
									DELAY(ARM_LEFT, 150),
									SET_ANGLE_D0(ARM_LEFT, 80),
									...
									DELAY(ARM_LEFT, 150),
		BARRIER(ARM_RIGHT, 1),		BARRIER(ARM_LEFT, 1),		BARRIER(BOUNCE_RIGHT, 1),			BARRIER(BOUNCE_LEFT, 1),
									SET_ANGLE_D0(ARM_LEFT, 40),	SET_ANGLE_D1(BOUNCE_LEFT, 80, 250),
									DELAY(ARM_LEFT, 150),
		BARRIER(ARM_RIGHT, 2),		BARRIER(ARM_LEFT, 2),		BARRIER(BOUNCE_RIGHT, 2),			BARRIER(BOUNCE_LEFT, 2),
		SET_ANGLE_D1(ARM_RIGHT, 40, 200),	SET_ANGLE_D1(ARM_LEFT, 40, 200),	SET_ANGLE_D1(BOUNCE_RIGHT, 90, 200),	SET_ANGLE_D1(BOUNCE_LEFT, 90, 200),
		FINISH(ARM_RIGHT),			FINISH(ARM_LEFT),			FINISH(BOUNCE_RIGHT),			FINISH(BOUNCE_LEFT)
};

__attribute__((unused)) static uint32_t emote_excited[] =
{
		HEADER(4),
		START(ARM_RIGHT),			START(ARM_LEFT),				START(BOUNCE_RIGHT),				START(BOUNCE_LEFT),
		SET_ANGLE_D0(ARM_RIGHT, 150),SET_ANGLE_D0(ARM_LEFT, 150),	SET_ANGLE_D0(BOUNCE_RIGHT, 50), 	SET_ANGLE_D0(BOUNCE_LEFT, 50),
		DELAY(ARM_RIGHT, 150),		DELAY(ARM_LEFT, 150),			DELAY(BOUNCE_RIGHT, 150),			DELAY(BOUNCE_LEFT, 150),
		SET_ANGLE_D0(ARM_RIGHT, 80),SET_ANGLE_D0(ARM_LEFT, 80),		SET_ANGLE_D0(BOUNCE_RIGHT, 100), 	SET_ANGLE_D0(BOUNCE_LEFT, 100),
		DELAY(ARM_RIGHT, 150),		DELAY(ARM_LEFT, 150),			DELAY(BOUNCE_RIGHT, 150),			DELAY(BOUNCE_LEFT, 150),
		SET_ANGLE_D0(ARM_RIGHT, 150),SET_ANGLE_D0(ARM_LEFT, 150),	SET_ANGLE_D0(BOUNCE_RIGHT, 50), 	SET_ANGLE_D0(BOUNCE_LEFT, 50),
		DELAY(ARM_RIGHT, 150),		DELAY(ARM_LEFT, 150),			DELAY(BOUNCE_RIGHT, 150),			DELAY(BOUNCE_LEFT, 150),
		SET_ANGLE_D0(ARM_RIGHT, 80),SET_ANGLE_D0(ARM_LEFT, 80),		SET_ANGLE_D0(BOUNCE_RIGHT, 100), 	SET_ANGLE_D0(BOUNCE_LEFT, 100),
		...
		SET_ANGLE_D0(ARM_RIGHT, 150),SET_ANGLE_D0(ARM_LEFT, 150),	SET_ANGLE_D0(BOUNCE_RIGHT, 50), 	SET_ANGLE_D0(BOUNCE_LEFT, 50),
		DELAY(ARM_RIGHT, 150),		DELAY(ARM_LEFT, 150),			DELAY(BOUNCE_RIGHT, 150),			DELAY(BOUNCE_LEFT, 150),
		SET_ANGLE_D0(ARM_RIGHT, 40),SET_ANGLE_D0(ARM_LEFT, 40),		SET_ANGLE_D0(BOUNCE_RIGHT, 90), 	SET_ANGLE_D0(BOUNCE_LEFT, 90),
		DELAY(ARM_RIGHT, 150),		DELAY(ARM_LEFT, 150),			DELAY(BOUNCE_RIGHT, 150),			DELAY(BOUNCE_LEFT, 150),
...
__attribute__((unused)) static uint32_t* emotePool[] =
{
		emote_wave,
		emote_excited
};

__attribute__((unused)) static size_t emotePoolSizes[] =
{
		sizeof(emote_wave),
		sizeof(emote_excited)
};
