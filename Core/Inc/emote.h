...
__attribute__((unused)) static uint32_t testEmote[] =
{
		HEADER(4),
		START(ARM_RIGHT),			START(ARM_LEFT),			START(BOUNCE_RIGHT),			START(BOUNCE_LEFT),
		SET_ANGLE_D0(ARM_RIGHT, 0),
		DELAY(ARM_RIGHT, 600),
		SET_ANGLE_D0(ARM_RIGHT, 180),
		DELAY(ARM_RIGHT, 600),
		SET_ANGLE_D0(ARM_RIGHT, 90),
		DELAY(ARM_RIGHT, 600),
		BARRIER(ARM_RIGHT, 0),		BARRIER(ARM_LEFT, 0),		BARRIER(BOUNCE_RIGHT, 0),			BARRIER(BOUNCE_LEFT, 0),
									SET_ANGLE_D0(ARM_LEFT, 0),
									DELAY(ARM_LEFT, 600),
									SET_ANGLE_D0(ARM_LEFT, 180),
									DELAY(ARM_LEFT, 600),
									SET_ANGLE_D0(ARM_LEFT, 90),
									DELAY(ARM_LEFT, 600),
		BARRIER(ARM_RIGHT, 1),		BARRIER(ARM_LEFT, 1),		BARRIER(BOUNCE_RIGHT, 1),			BARRIER(BOUNCE_LEFT, 1),
																SET_ANGLE_D0(BOUNCE_RIGHT, 0),
																DELAY(BOUNCE_RIGHT, 600),
																SET_ANGLE_D0(BOUNCE_RIGHT, 180),
																DELAY(BOUNCE_RIGHT, 600),
																SET_ANGLE_D0(BOUNCE_RIGHT, 90),
																DELAY(BOUNCE_RIGHT, 600),
		BARRIER(ARM_RIGHT, 2),		BARRIER(ARM_LEFT, 2),		BARRIER(BOUNCE_RIGHT, 2),			BARRIER(BOUNCE_LEFT, 2),
																									SET_ANGLE_D0(BOUNCE_LEFT, 0),
																									DELAY(BOUNCE_LEFT, 600),
																									SET_ANGLE_D0(BOUNCE_LEFT, 180),
																									DELAY(BOUNCE_LEFT, 600),
																									SET_ANGLE_D0(BOUNCE_LEFT, 90),
																									DELAY(BOUNCE_LEFT, 600),
