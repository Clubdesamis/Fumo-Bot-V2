...
__attribute__((unused)) static uint32_t emote_wave[] =
{
		...
		BARRIER(ARM_RIGHT, 1),		BARRIER(ARM_LEFT, 1),		BARRIER(BOUNCE_RIGHT, 1),			BARRIER(BOUNCE_LEFT, 1),
									...
									DELAY(ARM_LEFT, 150),
		BARRIER(ARM_RIGHT, 2),		BARRIER(ARM_LEFT, 2),		BARRIER(BOUNCE_RIGHT, 2),			BARRIER(BOUNCE_LEFT, 2),
		SET_ANGLE_D1(ARM_RIGHT, 40, 200),	SET_ANGLE_D1(ARM_LEFT, 40, 200),	SET_ANGLE_D1(BOUNCE_RIGHT, 80, 200),	SET_ANGLE_D1(BOUNCE_LEFT, 80, 200),
		FINISH(ARM_RIGHT),			FINISH(ARM_LEFT),			FINISH(BOUNCE_RIGHT),			FINISH(BOUNCE_LEFT)
};
...
__attribute__((unused)) static uint32_t emote_excited[] =
{
		...
		SET_ANGLE_D0(ARM_RIGHT, 150),SET_ANGLE_D0(ARM_LEFT, 150),	SET_ANGLE_D0(BOUNCE_RIGHT, 50), 	SET_ANGLE_D0(BOUNCE_LEFT, 50),
		DELAY(ARM_RIGHT, 150),		DELAY(ARM_LEFT, 150),			DELAY(BOUNCE_RIGHT, 150),			DELAY(BOUNCE_LEFT, 150),
		SET_ANGLE_D0(ARM_RIGHT, 40),SET_ANGLE_D0(ARM_LEFT, 40),		SET_ANGLE_D0(BOUNCE_RIGHT, 80), 	SET_ANGLE_D0(BOUNCE_LEFT, 80),
		DELAY(ARM_RIGHT, 150),		DELAY(ARM_LEFT, 150),			DELAY(BOUNCE_RIGHT, 150),			DELAY(BOUNCE_LEFT, 150),
